...
function themeFramePadding(){
	...
	if(jQuery("#slider-range-3").length > 0 )
	{
		...
		if(themeOptionItemValue != ''){
				if(themeOptionItem == 'themeStandardColor'){
					...
					if( themeOptionItemValue == 'left'){
							...
							var logoheaderHTML =  jQuery('<div>').append(jQuery('.header-nav .logo-header').clone()).html(); 
							var navbarHTML = jQuery('<div>').append(jQuery('.header-nav .navbar-nav').clone()).html(); 
							var footermenuHTML = jQuery('<div>').append(jQuery('.header-nav .footer-menu').clone()).html(); 
